...
1. Unzip this file and copy the `odtk_codesamples_v13.1.0.tgz` into the [`distributions`](./distributions) folder at
the same level as this file.
1. Run the following in a command line from this directory:

    ```
    docker build -t ansys/odtk/odtk-python:13.1.0-ubi8 .
    ```
...
1. Run the following in a command line from this directory:
    ...
    ```
    docker run -it --env-file ../configuration/licensing.env --name odtk-python --rm ansys/odtk/odtk-python:13.1.0-ubi8
    ```
...
1. Download version 13.0.0 or later of ODTK for Linux from [AGI Downloads](https://support.agi.com/downloads).
1. Unzip this file and copy the `odtk_codesamples_v13.1.0.tgz` into the [`distributions`](./distributions) folder at the same level as this file.
1. Run the following in a command line from this directory:
