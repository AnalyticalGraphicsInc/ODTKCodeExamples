...
1. Run `docker build -t ansys/odtk/odtk-webservice:7.10.1-ubi8 .` on the command line in this directory.
...
`docker run -d -p 5000:5000 --env-file ../configuration/licensing.env --name odtk-webservice --rm ansys/odtk/odtk-webservice:7.10.1-ubi8`
